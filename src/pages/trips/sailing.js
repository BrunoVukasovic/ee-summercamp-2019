...
export default () => {
  return (
    <Layout>
      ...
      <h2>Sailing</h2>
      <TripDescription>
        Set sail with us and cruise to the islands of Šolta, Brač or Čiovo on an
        unforgettable sailing tour. Anchor in secluded bay, discover rich
        ...
        Dalmatian lunch with fresh ingredients. During lunch indigenous Croatian
        eco-wines will be served on the boat.
        <br /> <br />
        ...
        private sail.
        <br /> <br />
        This one day trip is the perfect choice to explore the whole area around
        Split.
        <br /> <br />
      </TripDescription>
    </Layout>
