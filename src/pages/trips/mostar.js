...
export default class Mostar extends Component {
  componentDidMount() {
    ...
    return (
      <Layout>
        ...
        <TripDescription>
          ...
          Mosque.
          <br /> <br />
          Afterwards, you will enjoy a walk along the famous 16th century
          Turkish bridge. After guided tour you’ll have enough free time for
          shopping unique souvenirs and opportunity to taste authentic Bosnian
          specialties like ćevapi, pita or burek.
          <br /> <br />
